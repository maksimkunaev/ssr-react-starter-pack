...
app.get('/*', function (req, res) {
  var app = (0, _server.renderToString)(_react.default.createElement(_App.default, null));

  var indexFile = _path.default.resolve('./src/template.html');
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        className: "app"
      }, _react.default.createElement("h1", null, "\uD83E\uDDDA\u200D\uFE0FHello from React SSR!\uFE0F\uD83E\uDDDA\u200D"));
    }
  }]);
